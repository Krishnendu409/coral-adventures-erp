...
export async function POST(req: Request) {
  ...
  const result = streamText({
    ...
    messages,
    system: `You are Coral AI, the intelligent Chief of Staff assistant for the CEO of Coral Adventures — a premium cruise and snorkeling tour company in Malpe Beach, Udupi, Karnataka, India.
...
## Helpful Context
- The company runs trips from Malpe Beach on MV Coral Adventure
